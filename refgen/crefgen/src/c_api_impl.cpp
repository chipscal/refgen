...
template<typename R>
inline void *new_refgen(R alpha_rate1, R r1, R alpha_rate2, R r2, R alpha_slow, R max_var, 
...
void *new_refgen_float(float alpha_rate1, float r1, float alpha_rate2, float r2, float alpha_slow, float max_var) {
	return new_refgen<float>(alpha_rate1, r1, alpha_rate2, r2, alpha_slow, max_var);
}

void *new_refgen_float_ext(float alpha_rate1, float r1, float alpha_rate2, float r2, float alpha_slow, float max_var,
		unsigned int max_iter, float max_delta, float a, float A, float alpha, float c, float gamma) {

	return new_refgen<float>(alpha_rate1, r1, alpha_rate2, r2, alpha_slow, max_var, max_iter, max_delta, a, A, alpha, c, gamma);
}

void *new_refgen_double(double alpha_rate1, double r1, double alpha_rate2, double r2, double alpha_slow, double max_var) {
	return new_refgen<double>(alpha_rate1, r1, alpha_rate2, r2, alpha_slow, max_var);
}

void *new_refgen_double_ext(double alpha_rate1, double r1, double alpha_rate2, double r2, double alpha_slow, double max_var,
	unsigned int max_iter, double max_delta, double a, double A, double alpha, double c, double gamma) {

	return new_refgen<double>(alpha_rate1, r1, alpha_rate2, r2, alpha_slow, max_var, max_iter, max_delta, a, A, alpha, c, gamma);
}
